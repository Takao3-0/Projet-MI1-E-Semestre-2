      ...
      <section class="prof-section">
        ...
        <div class="prof-cards-grid">
          ...
          <?php if ($role_actuel === "admin"): ?>
            <a href="#" class="prof-card prof-card-link">
              <div class="prof-card-icon">&#9881;</div>
              <div>
