        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Commandes</th>
                    <th>Statut</th>
                    <th>Actions <span class="admin-fake-hint" title="Boutons de d&eacute;mo, sans effet pour l&rsquo;instant">(d&eacute;mo)</span></th>
                </tr>
            </thead>
            ...
            <?php foreach ($tableau_users_page as $user): ?>
                ...
                <tr class="admin-user-row">
                    ...
                    <td class="admin-user-row-actions">
                        <button type="button" class="admin-fake-action-btn admin-fake-action-btn--block" title="Fonction fictive — &agrave; brancher plus tard">Bloquer / D&eacute;sactiver</button>
                        <button type="button" class="admin-fake-action-btn admin-fake-action-btn--vip" title="Fonction fictive — &agrave; brancher plus tard">VIP</button>
                    </td>
                </tr>
                <?php endif; ?>
            <?php endforeach; ?>
